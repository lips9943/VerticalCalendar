...
struct VECCalendarCreator {
    ...
    func appendCalendarsByDate(_ date: Date, calendarCount: Int = 3) -> LinkedList<VECSection> {
        return createCalendars(by: date, to: true, calendarCount: calendarCount)
    }
    
    func prependCalendarsByDate(_ date: Date, calendarCount: Int = 3) -> LinkedList<VECSection> {
...
extension VECCalendarCreator {
    ...
    private func createCalendars(by date: Date, to isAppending: Bool, calendarCount: Int) -> LinkedList<VECSection> {
        let list = LinkedList<VECSection>()
